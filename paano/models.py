...
class Question(db.Model):
    ...
    def url(self, category=None, **kwargs):
        ...
        return url_for('question', category_id=category.id,
                       category_title=clean(category.title),
                       question_id=self.id,
                       question_title=clean(self.title),
                       **kwargs)
...
class Category(db.Model):
    ...
    def url(self, **kwargs):
        return url_for('category', category_id=self.id,
                       category_title=clean(self.title), **kwargs)
